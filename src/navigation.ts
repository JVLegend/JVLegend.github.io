...
export const headerData = {
  ...
  actions: [{ text: 'Contato', href: getPermalink('/contact'), icon: 'tabler:mail' }],
};
...
export const footerData = {
  ...
  socialLinks: [
    { ariaLabel: 'LinkedIn', icon: 'tabler:brand-linkedin', href: 'https://www.linkedin.com/in/joaovictordias' },
    { ariaLabel: 'Twitter', icon: 'tabler:brand-twitter', href: 'https://twitter.com/joaovictor_ac' },
    { ariaLabel: 'Github', icon: 'tabler:brand-github', href: 'https://github.com/jvlegend' },
